...
webterm, and a quick way to add new configurations and URLS.
...
When you run the wrapper script (siab.rb) it will start up webterm
and the url will be active and you can play nethack in webterm.

It has been great for tossing in files with other services and
restarting webterm and testing.  (siab.rb restart)
